    ...
    <>
      <section className="Header">
        <div className="Header__navbar__mobilecontainer">
          <Hamburger
            class="Header__hamburger-navmenu"
            size={20}
            toggled={IsOpen}
            toggle={setIsOpen}
            onToggle={(toggled) => {
              if (toggled) {
                // open a menu
                let Header__navbar__mobile = document.getElementById(
        ...
        <div className="Header__logo">
          <NavLink to={`/`} className="Header__logo--link">
            ...
            <img
              ...
              src={dionysus_cabinet_logo}
              alt="Dionysus Cabinet"
            />
          </NavLink>
        </div>
      ...
      <div
        className="Header__navbar__mobile hidden tablet__hidden"
        id="Header__navbar__mobile"
      >
        <NavLink to="/liquor_cellar" onClick={OnClick}>
          <div className="Header__navbar--button">
            <div className="before_hover">Cellar</div>
